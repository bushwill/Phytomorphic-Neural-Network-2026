...
# 7 "/app/vlab/include/lpfgall.h" 2
...
using std::wcstombs;
using std::wctomb;
# 8 "/app/vlab/include/lpfgall.h" 2
...
# 9 "/app/vlab/include/lpfgall.h" 2
# 1 "/app/vlab/include/lparams.h" 1
# 10 "/app/vlab/include/lparams.h"
...
# 10 "/app/vlab/include/lpfgall.h" 2
# 1 "/app/vlab/include/lintrfc.h" 1
...
# 40 "/usr/include/c++/13/cmath" 3
# 5 "/app/vlab/include/lintrfc.h" 2
...
# 2283 "/usr/include/c++/13/type_traits" 3
 ...
 _Functor, _ArgTypes...
  ...
  template<typename _Functor, typename... _ArgTypes>
    ...
    { } ;
# 2632 "/usr/include/c++/13/type_traits" 3
...
# 2822 "/usr/include/c++/13/type_traits" 3
...
# 6 "/app/vlab/include/lintrfc.h" 2
...
# 7 "/app/vlab/include/lintrfc.h" 2
# 16 "/app/vlab/include/lintrfc.h"
...
# 214 "/app/vlab/include/lintrfc.h"
extern "C" {
struct __lc_V2f {
  float x, y;
};
...
# 11 "/app/vlab/include/lpfgall.h" 2
# 1 "/app/vlab/include/lsys.h" 1
# 14 "/app/vlab/include/lsys.h"
...
extern "C" int NumOfModuleIProductions(int iGroup, int iVGroup,
                                     __lc_ModuleIdType moduleId);
extern "C" const __lc_ProductionPredecessor &
GetProductionPredecessor(int , int );
extern "C" const __lc_ProductionPredecessor &
GetDecompositionPredecessor(int , int );
extern "C" const __lc_ProductionPredecessor &
GetInterpretationPredecessor(int , int , int );
extern "C" const __lc_ProductionPredecessor &
...
# 12 "/app/vlab/include/lpfgall.h" 2
# 1 "/app/vlab/include/stdmods.h" 1
...
Axiom: Init() SetColor(255) SB Down(val(14)) RollL(val(13)) A(val(12),0) EB VisualAid;
...
A(age,n) : {
 if (age >= val(12) && n < val(11)) {
        age = age - val(12);
  produce I(age,n) GetPos(0,0,0)
   SB

                Down(val(15) * func(1,n/val(11)))
                L(age,n)
            GetPos(0,0,0)
            EB
   RollL(180.0)
...
I(age,n): {
    ...
    float len = val(21) * func(6,n/val(11)) * tfunc(10,age);
    float wid = powf(len,val(23)) * val(22) * func(7,n/val(11));
...
L(age,n): {
 ...
 float len = val(16) * func(5,n/val(11)) * tfunc(9,age);

    nproduce SetWidth(powf(len,val(17)) * val(18) * func(2,float(0)));
 ...
 nproduce
  ...
  StartGC();
        ...
        for (x = 0.; x < 1.; x += DX) {
            ...
            nproduce BlendedContour(0,1,powf(x,0.2));

            nproduce F(len*DX);

      nproduce SetWidth(powf(len,val(17)) * val(18) * func(2,float(x)))
                    Down((val(19)*func(3,float(x)))*len*DX)
                    RollL((val(20)*func(4,float(x)))*len*DX);
        }
    nproduce F(len*(1.-x));
    produce EndGC();
}
